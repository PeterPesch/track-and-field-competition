...
def main():
    ...
    print('==========================')
    if check_eventtype:
        def check_itemeventtype(item):
            return check_eventtype(item.event)
    else:
        check_itemeventtype = None
    schedule.print(size=True, filter=check_itemeventtype)
